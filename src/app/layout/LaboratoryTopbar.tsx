...
import { getLaboratoryPageTitle } from '@/app/layout/laboratoryNavUtils'
    ...
    <header className="h-12 bg-surface-white border-b border-border-subtle flex justify-between items-center px-lg z-40 shrink-0">
      <div className="flex items-center min-w-0">
        <h1 className="font-headline-md text-headline-md font-semibold text-on-surface truncate m-0">
          {getLaboratoryPageTitle(location.pathname)}
        </h1>
      </div>
      ...
      <div className="flex items-center gap-md shrink-0">
        ...
        <div className="flex items-center bg-warning/10 text-warning px-sm py-xs rounded-full gap-xs border border-warning/20">
          <span className="w-1.5 h-1.5 bg-warning rounded-full animate-pulse" />
          <span className="font-label-md text-label-md whitespace-nowrap">Laboratory Active</span>
        </div>
